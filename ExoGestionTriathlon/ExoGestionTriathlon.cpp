...
int main()
{
    ...
    Categorie* J1 = new Categorie(1, "Junior", 15, 18, NULL);
    Categorie* S1 = new Categorie(2, "Sénior", 19, 30, NULL);
    ...
    std::cout << "Temperature Eau :" << J11nage.GetTemperature() << "°C";

        // 7. À partir de l'Inscription de J11, récupérer le Triathlon et les Inscriptions associées
    std::cout << "les inscritpion de J11" << J11nage.GetLesInscriptions();
